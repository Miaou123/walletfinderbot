...
function isWalletInteresting(walletData) {
    ...
    const criteria = [
        { name: 'Balance > 0.1', condition: parseFloat(balance) > 5 },
        { name: 'Total value > 10000', condition: total_value > 20000 },
        { name: 'Realized profit 30d > 5000', condition: realized_profit_30d > 10000 },
        { name: 'Winrate > 0.3', condition: winrate > 0.5 },
        { name: '5 < Buy 30d < 1000', condition: buy_30d > 5 && buy_30d < 1000 },
        { name: '200 < Token avg cost < 50000', condition: token_avg_cost > 200 && token_avg_cost < 5000 },
        { name: 'Token sold avg profit > 200', condition: token_sold_avg_profit > 200 },
        { name: 'PNL 2x-5x num > 2', condition: pnl_2x_5x_num > 5 },
        { name: 'PNL > 5x num > 0', condition: pnl_gt_5x_num > 2 }
    ];
