    ...
    async handleCommand(bot, msg, args, messageThreadId) {
        try {
            ...
            await bot.sendMessage(msg.chat.id, 
                "An error occurred while displaying the help information.", 
...
/dp (dexpaid) - Show if dexscreener is paid for a token, also shows adds/boosts.
/em (entrymap)- Show the entryMap for the top holders of a token.
...
`;
    ...
    async sendSpecificHelp(bot, msg, command, messageThreadId) {
        ...
        await bot.sendLongMessage(msg.chat.id, specificHelpMessage, { 
            message_thread_id: messageThreadId 
        }, true);
    }
}
